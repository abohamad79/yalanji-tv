...
const SEED = {
  yalanji: {
    ...
    lang: 'ar',
    menu: [
      { n: 'أطباق رئيسية', n2: 'מנות עיקריות', i: [['منسف كدر خروف', 95], ['منسف كدر عجل', 85],
        ['منسف قبوله', 65], ['منسف عائلي', 330], ['ورق عنب', 65], ['فته يلنجي', 65],
        ['نودلز', 55], ['ششبرك', 60], ['شريمس وكلاماري', 90], ['رز ساده وسط', 35]] },
      { n: 'معجنات', n2: 'מאפים', i: [['كبة مقلية بالحبة', 7], ['صفيحة أرمنية', 7],
        ['صفيحة عربية', 7], ['ملوّح أجبان', 5], ['كرات زيتون', 5], ['مثلثات بيتسا', 6],
        ['أصابع جبنة وزعتر', 5], ['ميكس أجبان', 7], ['سيجاريم باللحمة', 8]] },
      { n: 'مقبّلات', n2: 'מתאבנים', i: [['حمص', 13], ['متبل', 13], ['ذرة', 15], ['معكرونة باردة', 15],
        ['باذنجان ميكس', 15], ['لبنة مثوّمة', 15], ['زهرة بطحينة', 15]] },
      { n: 'سلطات', n2: 'סלטים', i: [['تبولة', 45], ['فتوش', 55], ['حلومة', 60], ['عربية', 40]] },
      { n: 'مشروبات', n2: 'משקאות', i: [['قهوة عربية', 20], ['شاي أعشاب', 25],
